...
namespace Unity.FPS.Gameplay
{
    public class OverheatBehavior : MonoBehaviour
    {
        ...
        void OnDisable()
        {
            if (SteamVfx != null)
            {
                var emission = SteamVfx.emission;
        ...
        void CacheSteamVfxEmissionModule()
        {
            if (SteamVfx != null)
            {
            ...
            {
                m_SteamVfxEmissionModule = default;
            }
        }
        ...
        void Update()
        {
            ...
            if (currentAmmoRatio != m_LastAmmoRatio)
            {
                ...
                {
                    var emission = SteamVfx.emission;
                    emission.rateOverTimeMultiplier = SteamVfxEmissionRateMax * (1f - currentAmmoRatio);
                    m_SteamVfxEmissionModule = emission;
                }
            }
